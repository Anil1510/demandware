 ...
 * @module models/SiteGenAbstractModel
 */

/* API Includes */
var Class = require('~/cartridge/scripts/util/SiteGenClass').SiteGenClass;
var Logger = require('dw/system/Logger');

var SiteGenAbstractModel = Class.extend({
    /**
     ...
     * @constructs module:models/SiteGenAbstractModel~SiteGenAbstractModel
     * @param obj {Object}
     ...
     *
     * @abstract
     * @alias module:models/SiteGenAbstractModel~SiteGenAbstractModel/get
     * @return {Void}
     */
    get: function () {
        Logger.warn('Generic helper access method "get()" not implemented for subclass');
        return new SiteGenAbstractModel({custom: {}});
    },
     ...
     * @alias module:models/SiteGenAbstractModel~SiteGenAbstractModel/getValue
     ...
     * @alias module:models/SiteGenAbstractModel~SiteGenAbstractModel/setValue.
     ...
     * @alias module:models/SiteGenAbstractModel~SiteGenAbstractModel/initProperties
     */
     ...
     *
     * @alias module:models/SiteGenAbstractModel~SiteGenAbstractModel/__noSuchMethod__
...
/** The SiteGenAbstractModel class */
module.exports = SiteGenAbstractModel;
